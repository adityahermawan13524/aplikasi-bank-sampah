...
public class update_data_nasabah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_data_nasabah);
        ...
        progressDialog = new ProgressDialog(update_data_nasabah.this);
        progressDialog.setTitle("Loading");
        progressDialog.setMessage("Menyimpan Data...");

        progressDialog1 = new ProgressDialog(update_data_nasabah.this);
        ...
        radioButtonUser = findViewById(R.id.user);
        ...
        etDob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //date picker
                picker = new DatePickerDialog(update_data_nasabah.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btnupdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(textName.isEmpty() && textAlamat.isEmpty() && textEmail.isEmpty() && textDob.isEmpty() && textNoHp.isEmpty()){
                    Toast.makeText(update_data_nasabah.this, "Silahkan Isi Semua Data", Toast.LENGTH_SHORT).show();
                }else {
                    gender = radioButtontbGenderSelected.getText().toString();
                    user = radioButtonUser.getText().toString();

                    Update_Data(textName, textAlamat, textEmail, textDob, textNoHp,gender,textPassword,user);
                    Toast.makeText(update_data_nasabah.this, "Update Data Berhasil", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    void  Update_Data(final String nama, final String alamat, final String email, final String dob, final String nohp, final String gender, final String password, final String status){
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (resp.equals("[{\"status \":\"succses\"}]")){
                                    AlertDialog.Builder builder = new AlertDialog.Builder(update_data_nasabah.this);
                                    builder.setMessage("Data Sukses Terupdate");
                                    builder.setPositiveButton("ok.", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            Intent intent = new Intent(update_data_nasabah.this, data_nasabah.class);
                                    ...
                                    Toast.makeText(update_data_nasabah.this, "Update data Gagal", Toast.LENGTH_SHORT).show();
                                }
    ...
    void tampil_data_nasabah(){
        if (cekNetworkConnection()){
            ...
            StringRequest request = new StringRequest(
                ...
                @Override
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(update_data_nasabah.this, "GAGAL AMBIL DATA", Toast.LENGTH_SHORT).show();
                }
            }
            );
            RequestQueue requestQueue = Volley.newRequestQueue(this);
