...
public class cari_nama_penarikan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cari_nama_penarikan);
        ...
        Nama = findViewById(R.id.p_crnama);
        listView = findViewById(R.id.p_list_nama);
        ...
        StringRequest request = new StringRequest(
            ...
            public void onResponse(String response) {
                try {
                    ...
                    final adpter_cari_username adapter = new adpter_cari_username(cari_nama_penarikan.this, model);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(cari_nama_penarikan.this, "terjadi kesalahan", Toast.LENGTH_SHORT).show();
            }
        }
        );
